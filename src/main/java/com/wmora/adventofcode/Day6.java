...
class Day6 {
    ...
    String getModifiedMessage(List<String> messages) {
        String output = "";
        ...
        for (int i = 0; i < columns; i++) {
            ...
            Map.Entry<String, Integer> leastRepeatedEntry = null;
            for (Map.Entry<String, Integer> entry : occurrences.entrySet()) {
                if (leastRepeatedEntry == null || leastRepeatedEntry.getValue() > entry.getValue()) {
                    leastRepeatedEntry = entry;
                }
            }
            output += leastRepeatedEntry.getKey();
        }
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        System.out.println(new Day6().getModifiedMessage(messages));
    }
}
